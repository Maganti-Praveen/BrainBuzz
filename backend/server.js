          ...
          questions: [
            {
              ...
              {
                text: "Pavan Sai is _______",
                options: [
                  { text: "Male", isCorrect: false },
                  { text: "Female", isCorrect: false },
                  { text: "Others", isCorrect: true },
                  { text: "0.5", isCorrect: false }
                ]
              },
              {
                text: "Ee year rakhi evaru katinchukuntaru ?",
                options: [
                  { text: "Pavan Sai", isCorrect: false },
                  { text: "Srinivas Bhargav", isCorrect: true },
